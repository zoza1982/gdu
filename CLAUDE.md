...
**Parallel Processing**: The analyzer uses goroutines with concurrency limits (3×GOMAXPROCS) for parallel directory traversal. See `pkg/analyze/parallel.go` for the implementation.
