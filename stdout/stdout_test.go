...
func TestAnalyzePath(t *testing.T) {
	...
	ui := CreateStdoutUI(output, false, false, false, false, false, true, false, false, 0, false, false)
...
func TestShowSummary(t *testing.T) {
	...
	ui := CreateStdoutUI(output, true, false, true, false, true, false, false, false, 0, false, false)
	ui.SetIgnoreDirPaths([]string{"/xxx"})
	err := ui.AnalyzePath("test_dir", nil)
	assert.Nil(t, err)
	err = ui.StartUILoop()
...
func TestShowSummaryBw(t *testing.T) {
	...
	ui := CreateStdoutUI(output, false, false, false, false, true, false, false, false, 0, false, false)
	ui.SetIgnoreDirPaths([]string{"/xxx"})
	err := ui.AnalyzePath("test_dir", nil)
	assert.Nil(t, err)
	err = ui.StartUILoop()
...
func TestShowTop(t *testing.T) {
	...
	ui := CreateStdoutUI(output, true, false, true, false, true, false, false, false, 2, false, false)
	ui.SetIgnoreDirPaths([]string{"/xxx"})
	err := ui.AnalyzePath("test_dir", nil)
	assert.Nil(t, err)
	err = ui.StartUILoop()
...
func TestShowTopBw(t *testing.T) {
	...
	ui := CreateStdoutUI(output, false, false, false, false, true, false, false, false, 2, false, false)
	ui.SetIgnoreDirPaths([]string{"/xxx"})
	err := ui.AnalyzePath("test_dir", nil)
	assert.Nil(t, err)
	err = ui.StartUILoop()
...
func TestAnalyzeSubdir(t *testing.T) {
	...
	ui := CreateStdoutUI(output, false, false, false, false, false, false, false, false, 0, false, false)
	ui.SetIgnoreDirPaths([]string{"/xxx"})
...
func TestAnalyzePathWithColors(t *testing.T) {
	...
	ui := CreateStdoutUI(output, true, false, true, false, false, false, false, false, 0, false, false)
	ui.SetIgnoreDirPaths([]string{"/xxx"})
	err := ui.AnalyzePath("test_dir/nested", nil)
...
func TestAnalyzePathWoUnicode(t *testing.T) {
	...
	ui := CreateStdoutUI(output, false, true, true, false, false, false, false, false, 0, false, false)
...
func TestItemRows(t *testing.T) {
	...
	ui := CreateStdoutUI(output, false, true, false, false, false, false, false, false, 0, false, false)
...
func TestShowDevicesWithColor(t *testing.T) {
	...
	ui := CreateStdoutUI(output, true, true, true, false, false, false, false, false, 0, false, false)
	err := ui.ListDevices(getDevicesInfoMock())
...
func TestFormatSizeDec(t *testing.T) {
	...
	ui := CreateStdoutUI(output, true, true, true, false, false, false, true, false, 0, false, false)
...
func TestFormatSizeRaw(t *testing.T) {
	...
	ui := CreateStdoutUI(output, true, true, true, false, false, false, true, true, 0, false, false)
...
func TestAnalyzePathWithReverseSort(t *testing.T) {
	...
	ui := CreateStdoutUI(output, false, false, false, false, false, true, false, false, 0, true, false)
	ui.SetIgnoreDirPaths([]string{"/xxx"})
	err := ui.AnalyzePath("test_dir", nil)
	assert.Nil(t, err)
	err = ui.StartUILoop()
...
func TestReverseSortWithColors(t *testing.T) {
	...
	ui := CreateStdoutUI(output, true, false, true, false, false, false, false, false, 0, true, false)
	ui.SetIgnoreDirPaths([]string{"/xxx"})
	err := ui.AnalyzePath("test_dir/nested", nil)
...
func TestReverseSortWithSummarize(t *testing.T) {
	...
	ui := CreateStdoutUI(output, false, false, false, false, true, false, false, false, 0, true, false)
	ui.SetIgnoreDirPaths([]string{"/xxx"})
	err := ui.AnalyzePath("test_dir", nil)
	assert.Nil(t, err)
	err = ui.StartUILoop()
...
func TestReverseSortWithTop(t *testing.T) {
	...
	ui := CreateStdoutUI(output, true, false, true, false, true, false, false, false, 2, true, false)
	ui.SetIgnoreDirPaths([]string{"/xxx"})
	err := ui.AnalyzePath("test_dir", nil)
	assert.Nil(t, err)
	err = ui.StartUILoop()
...
func TestReverseSortFromAnalysisFile(t *testing.T) {
	...
	ui := CreateStdoutUI(output, true, true, true, false, false, false, false, false, 0, true, false)
	err = ui.ReadAnalysis(input)
